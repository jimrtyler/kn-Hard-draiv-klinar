...
#GUI Variables
$FormTitleText = "ಡಿಸ್ಕ್ ಕ್ಲೀನರ್ by Jim Tyler (PowerShellEngineer.com)"
$SelectDiskLabelText = "ಡಿಸ್ಕ್ ಆಯ್ಕೆಮಾಡಿ:"
$FreeSpaceLabelText = "ಫ್ರೀ ಸ್ಪೇಸ್ (ಗಿಗಾಬೈಟ್‌ಗಳು): "
$TotalSpaceLabelText = "ಒಟ್ಟು ಸ್ಥಳ (ಗಿಗಾಬೈಟ್‌ಗಳು): "
$JunkFoundLabelText = "ಜಂಕ್ ಕಂಡುಬಂದಿದೆ (ಗಿಗಾಬೈಟ್‌ಗಳು):"
$CleanDiskBtnText = "ಡಿಸ್ಕ್ ಅನ್ನು ಸ್ವಚ್ಛಗೊಳಿಸಿ *ಫೈಲ್‌ಗಳನ್ನು ಅಳಿಸಿ*"
$SpaceCleanedLabelText = "ಸ್ವಚ್ಛಗೊಳಿಸಿದ ಜಾಗ (ಗಿಗಾಬೈಟ್‌ಗಳು): "
$LogFileLabelText = "ಲಾಗ್ ಫೈಲ್ ಕಂಡುಬಂದಿದೆ: $abcdefg"
$CreditLabelText = "ಜಿಮ್ ಟೈಲರ್ ಅವರಿಂದ ಸ್ಕ್ರಿಪ್ಟ್ - PowerShellEngineer.com"
$LogFileLocatedText = "ಲಾಗ್ ಫೈಲ್ ಕಂಡುಬಂದಿದೆ"
$AnalyzingDriveText = "ಡ್ರೈವ್‌ಗಳನ್ನು ವಿಶ್ಲೇಷಿಸಲಾಗುತ್ತಿದೆ..."
$BrowsersAreRunningText = "ಬ್ರೌಸರ್‌ಗಳು ಚಾಲನೆಯಲ್ಲಿವೆ... ಬಳಕೆದಾರರಿಗೆ ಸೂಚಿಸಿ..."
$PleaseCloseBrowsersText = "ದಯವಿಟ್ಟು ಎಲ್ಲಾ ವೆಬ್ ಬ್ರೌಸರ್‌ಗಳನ್ನು ಮುಚ್ಚಿ ಮತ್ತು ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ."
$CleaningDriveText = "ಡ್ರೈವ್ ಅನ್ನು ಸ್ವಚ್ಛಗೊಳಿಸಲಾಗುತ್ತಿದೆ..."
